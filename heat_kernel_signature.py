...
def compute_Dinv(mesh, t):
    ...
    Args:
      mesh: A Trimesh object with n vertices.
      t: A float.
...
def mesh_Laplacian(mesh, t):
    ...
    Dinv = compute_Dinv(mesh, t)  # sparse
    H = compute_H(mesh, t)  # dense
